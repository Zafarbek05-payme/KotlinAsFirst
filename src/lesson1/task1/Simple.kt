 ...
 */
fun angleInDegrees(degrees: Int, minutes: Int, seconds: Int): Double {
    val degrees = (degrees + minutes/60 + seconds/3600)
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    val departMin = hoursDepart * 60 + minutesDepart
    val arriveMin = hoursArrive * 60 + minutesArrive
...
fun accountInThreeYears(initial: Double, percent: Double): Double {
    fun accountInThreeYears(initial: Double, percent: Double): Double {
    return (initial * (1 + percent/100).pow(3.0))
}
...
fun numberRevert(number: Int): Int {
    var string = number.toString().reversed()
    return string.toInt()   
}
